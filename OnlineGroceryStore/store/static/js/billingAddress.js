...
function validateAndSubmit()
{
	...
	request.open('POST','/addBillingAddress', false);
...
function makeDefault(reqFrom) {
    ...
    var request = new XMLHttpRequest();
    request.open('POST', 'setDefaultBilling', true);
    request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function deleteAddress(reqFrom) {
    var request = new XMLHttpRequest();
    request.open('POST', 'deleteBillingAddress', true);
    request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function updateAddress() {
	...
	var request = new XMLHttpRequest();
	request.open('POST','updateBillingAddress', false);
	request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
